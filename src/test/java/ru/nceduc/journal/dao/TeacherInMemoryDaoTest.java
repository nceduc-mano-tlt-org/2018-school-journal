...
public class TeacherInMemoryDaoTest {
    ...
    public void setUp() {
        ...
        Section section = new Section("1" ,project ,sectionName);
        Group g1 = new Group("2", project, section,"1");
        Group g2 = new Group("3", project, section,"2");
    ...
    public void testFindTeacherOnFail_1() throws SQLException {
        dao.find(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testFindTeacherOnFail_2() throws SQLException {
        dao.find("");
    }
    ...
    @Test
    public void testUpdateTeacher_1() throws SQLException {
    ...
    @Test
    public void testUpdateTeacher_2() throws SQLException {
